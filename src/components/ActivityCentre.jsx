...
const ActitvityImageSlideshow = () => {
  ...
  useEffect(() => {
    const fetchMedia = async () => {
      setIsLoading(true)
      try {
        const response = await axios.get(process.env.NEXT_PUBLIC_STRAPI_API_URL + "/activity-centres?populate=*")
...
export default ActitvityImageSlideshow;
