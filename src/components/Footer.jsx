...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 flex w-full mt-4 p-4">
        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-20">
            ...
            <div className="text-white">
              <div>For any enquiries and concern</div>
              <div>Contact-9056290560</div>
              <div>Email-enquiry@anandfeeds.com</div>

              <div>Address-T.D Arora Feed Mills,Focal Point,Rajpura,Punjab</div>
            </div>
            ...
            <div>
              ...
              <ul className="text-gray-400 font-medium">
                <li className="mb-4">
                  <a
                    target="_blank"
                    href="https://privacy-policy.anandfeeds.com"
                    className="hover:underline"
                  >
                    Privacy Policy
                  </a>
                ...
                <li className="mb-4">
                  <a
                    target="_blank"
                    href="https://return-policy.anandfeeds.com"
                    className="hover:underline"
                  >
                    Return Policy
                  </a>
